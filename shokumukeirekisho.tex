...
\newcommand\firstnametext{Alexis}  % \firstname will be defined by moderncv
\newcommand\firstnamekana{アレクシ}
\newcommand\lastnametext{Jeandeau}  % \lastname will be defined by moderncv
\newcommand\lastnamekana{ジャンドー}

% Personal data
\lineskiplimit=5pt
\name{\ruby{\lastnametext}{\lastnamekana}}{\ruby{\firstnametext}{\firstnamekana}}
\lineskiplimit=1pt
\title{職務経歴書}
...
\AfterPreamble{\hypersetup{
    pdfcreator     = {\LaTeX{}},
    pdfauthor      = {\firstnametext{}~\lastnametext{}},
    pdftitle       = {\firstnametext{}~\lastnametext{} -- 職務経歴書},
    pdfsubject     = {\firstnametext{}~\lastnametext{} -- 職務経歴書},
    pdfkeywords    = {\firstnametext{}~\lastnametext{}, \lastnamekana{}・\firstnamekana{}, 職務経歴書}
}}
